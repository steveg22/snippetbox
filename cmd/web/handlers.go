...
import (
	...
	"github.com/steveg22/snippetbox/internal/validator"
)
...
func (app *application) userSignupPost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.MaxChars(form.Password, 72), "password", "This field must be at most 72 bytes long")
...
func (app *application) userLoginPost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.Matches(form.Email, validator.EmailRegex), "email", "This field must be a valid email address")
	form.CheckField(validator.NotBlank(form.Password), "password", "This field cannot be blank")
	form.CheckField(validator.MaxChars(form.Password, 72), "password", "This field must not be more than 72 bytes long")
